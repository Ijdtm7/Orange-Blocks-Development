    ...
    public static class Handler implements IMessageHandler<PacketEntityLocation, IMessage>
    {
        ...
        public void handleClient(PacketEntityLocation message)
        {
            ...
            if(ent != null)
            {
                ...
                {
                    Main.eventHandlerClient.justTeleported = true;
                    Main.eventHandlerClient.mX = ent.motionX;
                    Main.eventHandlerClient.mY = ent.motionY;
                    Main.eventHandlerClient.mZ = ent.motionZ;
                }
            }
        }
    }
