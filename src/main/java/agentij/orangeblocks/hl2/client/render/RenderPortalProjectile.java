...
{
    public static final ResourceLocation txBlue = new ResourceLocation("hl2", "textures/entity/portalball_blue.png");
    public static final ResourceLocation txOrange = new ResourceLocation("hl2", "textures/entity/portalball_orange.png");
